	...
	return (
		<div className={`${styles.highlight_border} ${styles.floating} flex space-y-3 flex-col p-3`}>
			...
			<div className={`flex max-sm:flex-col space-x-10 max-sm:space-y-3 max-sm:pt-3 p-5 pb-3 text-xl text-center justify-center items-center max-sm:items-start ${styles.center_content_a}`}>
				<a className={styles.scale_on_hover} href={"https://www.github.com/tobiazsh"}><FaGithub /> GitHub</a>
				<a className={styles.scale_on_hover} href={"https://www.instagram.com/tobizsh"}><FaInstagram /> Instagram</a>
				<a className={styles.scale_on_hover} href={"https://www.youtube.com/@tobiazsh"}><FaYoutube /> YouTube</a>
			</div>
